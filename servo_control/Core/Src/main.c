...
//for(float temp=0;temp<=90;temp+=30)
//{Servo_SetAngle(0,temp);
//HAL_Delay(1000);}
...
Servo_SetAngle(0,180);
		...
		/*for(float temp=0;temp<=180;temp+=30)
	{
	Servo_SetAngle(1,temp);
	HAL_Delay(1000);
	}*/
...
//		HAL_Delay(1000);
//		Servo_SetAngle(2,20);//GRAB
//		
//	//Second grab and store
//		
//		HAL_Delay(3000);
//		Servo_SetAngle(0,88);
//	  Servo_SetAngle(1,0);
